...
public class ItemFusumaSakuraRiver extends ItemDoor {

	public ItemFusumaSakuraRiver(String unlocalizedName, Material material) {
	...
	public boolean onItemUse(ItemStack stack, EntityPlayer player, World world, int posX, int posY, int posZ, int side, float motionX, float motionY, float motionZ) {
		...
		if(side != 1) {
			...
			++posY;
			Block block = ModBlocks.fusumaSR;
