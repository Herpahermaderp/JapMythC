...
public class ModRecipes {
	...
	public static void init() {
		...
		GameRegistry.addRecipe(new ItemStack(ModBlocks.woods, 4, 0), new Object[] {"#", '#', new ItemStack(ModBlocks.logs, 0)});
		GameRegistry.addRecipe(new ItemStack(ModBlocks.woods, 4, 1), new Object[] {"#", '#', new ItemStack(ModBlocks.logs, 1)});
	}
}
