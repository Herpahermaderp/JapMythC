...
public class PacketISpawnParticlesGeneric extends AbstractClientMessage<PacketISpawnParticlesGeneric> {

	private ItemStack stack;
	private String commandSenderName;
	private float r;
	
	public PacketISpawnParticlesGeneric() {
		
	}
	
	public PacketISpawnParticlesGeneric(EntityPlayer player, float radius) {
	...
	protected void process(EntityPlayer player, Side side) {
		...
		if(commandSender != null && stack != null && stack.getItem() instanceof ISpawnParticlesGeneric) {
			...
			((ISpawnParticlesGeneric) stack.getItem()).spawnParticles(player.worldObj, commandSender, stack, player.posX, player.posY, player.posZ, r);
		}
	}
}
